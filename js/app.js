...
(function () {
  ...
  const PROJECTS = [
    { title: "Leadership Field Guide — Leap Virtuosi", ytid: "Hx4hQOsa9nM",
      genre: "COMMERCIAL", client: "Virtuosi League", durS: 197,
      log: "Enterprise leadership, unscripted. A conference sizzle cut from on-site interviews with CMO thought-leaders.",
  ...
  const SHORTS = [
    { title: "Rice Gai", ytid: "RGxEAopLYZo",
      genre: "SOCIAL", client: "Glacial Etch Media", vert: true,
      log: "Meet Gregory Delgadillo, also known as The Rice Gai. Serving up Thai Chicken and Rice.",
      role: "Editor, Colorist",
    ...
    { title: "Chess Game", ytid: "Nd3PvFDWDOY",
      ...
      log: "Part of a series cut for ADTV's new reality show with Megan Archer.",
      role: "Editor",
      outcome: "Will Megan be able to best the competition and predict their next move?" },
    { title: "ADTV — Reel 003", ytid: "lq6NAFn7css",
      genre: "SOCIAL", client: "ADTV", vert: true,
      log: "Part of a series cut for ADTV's new reality show with Megan Archer.",
      role: "Editor",
      outcome: "Megan gives the final reveal: a new reality show starring her!" },
    { title: "Gossip Girl — Reel 004", ytid: "OHB6G7gKE0E",
      genre: "SOCIAL", client: "ADTV", vert: true,
      log: "Part of a series cut for ADTV's new reality show with Megan Archer.",
      role: "Editor",
      outcome: "Are the rumors true?" },
    { title: "Tiramisu Latte", ytid: "KTOETjSxeEw",
      genre: "SOCIAL", client: "Manasiri Crepes", vert: true,
